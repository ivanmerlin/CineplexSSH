...
<html>
		  ...
		  <div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			  <ul class="nav navbar-nav">
				...
				<li class=" active"><a href="vipEvent.action"> &nbsp &nbsp 参加活动 &nbsp &nbsp </a></li>
    ...
    <div class="infobox center-block">
    	<c:forEach items="${eventList}" var="li">
    	<div class="center-block">
    		<div class=" center-block eventTitle">相关电影：${li.filmname}</div> 
    		<div class="eventContent"> ${li.question}
    		<button class="button" onclick="uploadEventId('${li.id}')">立即参加</button>
    		</div>
    ...
    <script type="text/javascript">
		function uploadEventId(id){

			location.href="vipEvent.action?chosenEvent="+id;
		}

...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse"
				...
				<li><a href="searchVipInfo.action"> &nbsp &nbsp 会员信息 &nbsp
					...
					<li class="active"><a href="editPlan.action"> &nbsp &nbsp 修改放映计划 &nbsp
							&nbsp </a></li>	
	...
	<h3 align="center">修改放映计划</h3>
	
	<form id="filmPlanForm" method="post" action="editPlanComplete.action">
		<div class="infobox center-block">

			<div class="form-group center-block">
				<label for="inputId">请选择未通过的放映计划</label> <select class="form-control"
					name="planInfo">
					<c:forEach items="${unpassedPlanList}" var="li">
						<option>${li.id} ${li.filmName} ${li.roomName} ${li.starttime} ${li.price}</option>
					</c:forEach>
				</select>
			</div>
			...
			<div class="form-group center-block">
				<label for="inputId">请输入电影价格</label> <input type="username"
					...
					placeholder="Enter the movie price" value="${filmPrice }">
			</div>
	...
	<script>
		...
		function upload(){
			document.getElementById('filmPlanForm').submit();
			alert("修改成功！");

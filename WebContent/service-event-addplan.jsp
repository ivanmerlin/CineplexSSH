...
<body>
	...
	<h3 align="center" style="margin-top:80px">还要为该活动指定别的放映计划吗？</h3>
	<form id="eventForm" method="post" action="makeEventPage.action">

		<div class="form-group center-block">
			<label for="inputId">请选择匹配的电影计划</label> 
			<select class="form-control" name="planInfo">
	...
	<button class="center-block button2" onclick="location.href='makeEventPage.action'">不再添加</button>
	...
	<script type="text/javascript">
		function upload(s) {
			...
			$.post("eventAddPlan.action", {
				'again' : s
			}, function response(data) {
				location.href = 'makeEventPage.action';
			});

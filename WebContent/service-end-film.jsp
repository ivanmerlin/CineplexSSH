...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li><a href="makeEventPage.action"> &nbsp &nbsp 制定活动
							&nbsp &nbsp </a></li>
				...
				<li  class="active" ><a href="endFilm.action"> &nbsp &nbsp 电影下线 &nbsp &nbsp </a></li>				
				</ul>
			</div>
			<!-- /.navbar-collapse -->
		</div>
	...
	<h3 align="center">选择下线的电影</h3>
	<form id="filmForm" method="post" action="endFilm.action">
		<div class="infobox center-block">


			<div class="form-group center-block">
				<label for="inputId">请选择下线的电影</label> <select class="form-control"
					name="filmName">
			...
			<div class="form-submit">
				...
				<a href="#" class="button center-block"
					onclick="document.getElementById('filmForm').submit();">提交</a>
			</div>
		</div>
	</form>

...
<html>
		  ...
		  <div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			  <ul class="nav navbar-nav">
				...
				<li class="active"><a href="vipRecommend.action"> &nbsp &nbsp 影片推荐 &nbsp &nbsp </a></li>
    ...
    <h4 align="center" style="margin-top:10px;"> 根据你的购票记录，推荐电影如下</h4>

	<table class="center-block table  table-bordered table-hover" style="width:600px;">
   			<tr>
	   			<th>电影名称</th>
	   			<th>电影时长</th>
	   			<th>类型</th>
	   		...
	   		<c:forEach items="${filmList}" var="li">
	   			<tr>	   				
	   				<td style="width:200px;">${li.name}</td>
	   				<td style="width:200px;" >${li.time}</td>
	   				<td style="width:200px;">${li.type}</td>
	   			</tr>
	   		</c:forEach>
	   		</table>

...
<body>
	...
	<h4 align="center" style="margin-top:120px;">您当前有积分：${user.credit}</h4>
	<h4 align="center" style="margin-top:10px;">请输入需要兑换的积分(积分兑换比例为10:1，如输入非10的整数倍，例18分，则按10分处理)：</h4>
	<form method="post" class="center-block creditForm" action="vipCredit.action">
